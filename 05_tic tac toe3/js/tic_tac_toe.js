...
const msgtxt3 = '<p class="image"><img src ="img/penguins.jpg" width=61px height=61px></p><p class="text animate__animated animate__lightSpeedInRight">Penguins Win!!(your turn)</p>';
const msgtxt4 = '<p class="image"><img src ="img/whitebear.jpg" width=61px height=61px></p><p class="text animate__animated animate__lightSpeedInLeft">WhiteBear Win!!(computer turn)</p>';
...
function bearTurn() {
    ...
    while(bearTurnEnd === "0") {
        ...
        // まだクマ目を選んでいない場合、クリックできマス目をランダムに選ぶ
...
function isReach(status) {
    ...
    lineArray.some(function (line) {
        ...
        // クマがペンギンのリーチ行あり場合、空いているクマ目を選択する
        if(bearTurnEnd === "1") {
