...
const elementbtnEqual = document.getElementById("btnEqual"); /* add */

// イベントを登録
elementSelect.addEventListener("change",clear);   //chg
elementNum1.addEventListener("change",clear);     //chg
elementNum2.addEventListener("change",clear);     //chg

elementbtnEqual.addEventListener("click",update); /* add */
